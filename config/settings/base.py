...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///opd-product")}
...
LOCAL_APPS = [
    'apps.api',
    'apps.users',
    'apps.product_types',  # Product Types
    'apps.product_groups',
    'apps.costs',
    'apps.prices',  # Prices
...
ADMINS = [
    ("""ERP Team@OpenDurian""", "admin@opendurian.com")
]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "opd-product API",
    "DESCRIPTION": "Documentation of API endpoints of opd-product",
    "VERSION": "1.0.0",
    "SERVE_PERMISSIONS": ["rest_framework.permissions.IsAdminUser"],
    "SERVERS": [
        {"url": "http://127.0.0.1:8000", "description": "Local Development server"},
        {"url": "https://product.opendurian.com", "description": "Production server"},
    ],
}
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': env("SIGNING_KEY", default="JWT_SIGNING_KEY"),
    'VERIFYING_KEY': None,
    'AUDIENCE': None,
    'ISSUER': None,
    'JWK_URL': None,
...
# END DJANGO REST-FRAMEWORK SIMPLE JWT
